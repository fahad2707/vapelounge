...
export default function Ticker() {
  ...
  return (
    <div className="home-ticker" style={{overflow:'hidden',padding:'14px 0',borderTop:'1px solid var(--line2)',borderBottom:'1px solid var(--line2)',background:'rgba(201,168,94,.04)'}}>
